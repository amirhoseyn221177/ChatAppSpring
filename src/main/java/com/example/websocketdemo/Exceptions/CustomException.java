...
public class CustomException extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler
    public final ResponseEntity<Object> handleBadToken(BadTokenException ex,WebRequest webRequest){
        BadTokenResponse badTokenResponse= new BadTokenResponse(ex.getMessage());
        return  new ResponseEntity<>(badTokenResponse,HttpStatus.BAD_REQUEST);
    }
}
